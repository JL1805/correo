...
const departmentUserAdd = function (data : ResetPaswordInterface) {
    const html = `
<!DOCTYPE html>
  ...
  <body
    ...
    <div style="display: none;"> You are invited to the ${data.departmentName} Department on CIVIX. </div>
                ...
                <td align="center" class="sm-px-24" style="font-family: 'Montserrat',Arial,sans-serif;">
                  <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%" cellpadding="0"
                    ...
                    align="left">
                        ...
                        <p style="font-weight: 600; font-size: 18px; margin-bottom: 10px; margin-top: 10px">Hey ${data.firstName},</p>
  
                        <p style="margin: 0 0 4px;">
                          You have been added to the CIVIX digital signage dashboard for ${data.departmentName}.
                        </p>
                        ...
                        <a href="${data.resetPasswordUrl}"
                          style="display: block; font-size: 14px; line-height: 100%; margin-bottom: 24px; --text-opacity: 1; color: #7367f0; text-decoration: none;">${data.resetPasswordUrl}</a>
                        <table style="font-family: 'Montserrat',Arial,sans-serif;" cellpadding="0" cellspacing="0"
                          role="presentation">
                          <tr>
                            <td
                              style="mso-padding-alt: 16px 24px; --bg-opacity: 1; background-color: #5a39a2; color:white; border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;">
                              <a href="${data.resetPasswordUrl}"
                        ...
                        <p style="margin: 20px 0 2px;">Welcome to the ${data.departmentName} Department. We are excited to have you onboard.</p>
                        ...
                        Have additional questions or need direct assistance? <br /> Contact our team at 
                          <a href="mailto:local@local.com" class="hover-underline"
                            style="--text-opacity: 1; color: #7367f0; text-decoration: none;">local@local.com</a>.
                        </p>
                      </td>
                    </tr>
                    <tr>
